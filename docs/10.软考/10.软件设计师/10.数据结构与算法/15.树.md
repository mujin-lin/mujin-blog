...
#### 4.2.2 完全二叉树 (Complete Binary Tree)
...
#### 4.2.3 二叉排序树 (Binary Sort Tree, BST)
...
#### 4.2.4 平衡二叉树 (Balanced Binary Tree, AVL Tree)
...
#### 4.2.6 线索二叉树 (Threaded Binary Tree)
