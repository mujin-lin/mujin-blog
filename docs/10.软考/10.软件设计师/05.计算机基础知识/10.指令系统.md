...
sidebar: true
article: true
description: 指令系统（Instruction Set Architecture, ISA），通常也被称为指令集
coverImg: https://testingcf.jsdelivr.net/gh/mujin-lin/mujin-blog-static/img/ruankao/instruction.webp
docAnalysis: true
inCatalogue: true
autoTitle: true
articleUpdate: true
...
- **时空图**：
  ...
  ![instruction-flow-line.webp](https://testingcf.jsdelivr.net/gh/mujin-lin/mujin-blog-static/img/ruankao/pages/instruction-flow-line.webp)
